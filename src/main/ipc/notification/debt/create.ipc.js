...
module.exports = async function createDebtNotification(params = {}, queryRunner = null) {
  ...
  try {
    // @ts-ignore
    const { debtId, workerId, workerName, amount, status, message, context = {}, _userId } = params;
