...
module.exports = async function createPaymentNotification(params = {}, queryRunner = null) {
  ...
  try {
    // @ts-ignore
    const { paymentId, workerId, workerName, amount, status, message, context = {}, _userId } = params;
