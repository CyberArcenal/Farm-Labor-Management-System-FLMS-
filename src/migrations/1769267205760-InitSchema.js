...
module.exports = class InitSchema1769267205760 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "debt_histories" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "transactionType" varchar NOT NULL DEFAULT ('payment'), "paymentMethod" varchar, "referenceNumber" varchar, "notes" varchar, "transactionDate" datetime NOT NULL DEFAULT (datetime('now')), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "debtId" integer, "paymentId" integer, CONSTRAINT "UQ_2dfbbaa4fc0769e0a1590ef18ad" UNIQUE ("referenceNumber"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pitaks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "location" varchar, "totalLuwang" decimal(5,2) NOT NULL DEFAULT (0), "status" varchar NOT NULL DEFAULT ('active'), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "bukidId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_debt_histories" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amountPaid" decimal(10,2) NOT NULL DEFAULT (0), "previousBalance" decimal(10,2) NOT NULL DEFAULT (0), "newBalance" decimal(10,2) NOT NULL DEFAULT (0), "transactionType" varchar NOT NULL DEFAULT ('payment'), "paymentMethod" varchar, "referenceNumber" varchar, "notes" varchar, "transactionDate" datetime NOT NULL DEFAULT (datetime('now')), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "debtId" integer, "paymentId" integer, CONSTRAINT "UQ_2dfbbaa4fc0769e0a1590ef18ad" UNIQUE ("referenceNumber"), CONSTRAINT "FK_b28e0e3c07469b9e12c2473adbb" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_440a93746399a8f39f6879185e6" FOREIGN KEY ("paymentId") REFERENCES "payments" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_payments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "grossPay" decimal(10,2) NOT NULL DEFAULT (0), "manualDeduction" decimal(10,2) DEFAULT (0), "netPay" decimal(10,2) NOT NULL DEFAULT (0), "status" varchar NOT NULL DEFAULT ('pending'), "paymentDate" datetime, "paymentMethod" varchar, "referenceNumber" varchar, "periodStart" datetime, "periodEnd" datetime, "totalDebtDeduction" decimal(10,2) NOT NULL DEFAULT (0), "otherDeductions" decimal(10,2) NOT NULL DEFAULT (0), "deductionBreakdown" json, "notes" varchar, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "workerId" integer, "pitakId" integer, CONSTRAINT "UQ_b1ccfcfabdda075c2742c0060c6" UNIQUE ("referenceNumber"), CONSTRAINT "FK_a03c9d5254fca3435262af9721c" FOREIGN KEY ("workerId") REFERENCES "workers" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_8bedf6595ab5a0ea80a6e008cff" FOREIGN KEY ("pitakId") REFERENCES "pitaks" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_PAYMENT_HISTORY_ACTION" ON "payment_histories" ("actionType") `);
        await queryRunner.query(`CREATE INDEX "IDX_PAYMENT_HISTORY_DATE" ON "payment_histories" ("changeDate") `);
        await queryRunner.query(`CREATE TABLE "temporary_pitaks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "location" varchar, "totalLuwang" decimal(5,2) NOT NULL DEFAULT (0), "status" varchar NOT NULL DEFAULT ('active'), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "bukidId" integer, CONSTRAINT "FK_236bcbe6fce4cf9be4f0669bbf7" FOREIGN KEY ("bukidId") REFERENCES "bukids" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
